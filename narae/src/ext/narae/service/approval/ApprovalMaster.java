 ...
 *
 * <p>
 * Use the <code>newApprovalMaster</code> static factory method(s), not the
 * <code>ApprovalMaster</code> constructor, to construct instances of this
...
@GenAsPersistable(serializable = Serialization.EXTERNALIZABLE_BASIC, properties = {
		...
		@GeneratedProperty(name = "owner", type = String.class), @GeneratedProperty(name = "active", type = int.class),
		@GeneratedProperty(name = "orderType", type = String.class, javaDoc = "占쏙옙占쏙옙/占쏙옙占쏙옙") })
public class ApprovalMaster extends _ApprovalMaster {
	...
	public String getLocaleState() {
		return ApprovalHelper.manager.getLocaleString(this.state);
	}
}
