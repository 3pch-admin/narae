 ...
 *
 * <p>
 * Use the <code>newCommonActivity</code> static factory method(s), not the
 * <code>CommonActivity</code> constructor, to construct instances of this
...
@GenAsPersistable(interfaces = {
		OwnPersistable.class }, serializable = Serialization.EXTERNALIZABLE_BASIC, properties = {
				...
				@GeneratedProperty(name = "title", type = String.class) }, foreignKeys = {
						@GeneratedForeignKey(name = "ActivityItemLink", myRoleIsRoleA = false, foreignKeyRole = @ForeignKeyRole(name = "item", type = wt.fc.Persistable.class), myRole = @MyRole(name = "activity")) })
public class CommonActivity extends _CommonActivity {
	 ...
	 **/
	public static CommonActivity newCommonActivity() throws WTException {
