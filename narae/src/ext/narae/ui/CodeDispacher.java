...
//				"</OPTION>");
		while (cadcreator.hasMoreElements()) {
			...
			if (oneCode.getCode().equals("N"))
				buffer.append(TAG_ENV_VALUE + EQUAL + SINGLE_QUATATION
						+ oneCode.getPersistInfo().getObjectIdentifier().toString() + "," + oneCode.getCode()
						+ SINGLE_QUATATION + BLANK + TAG_ENV_SELECTED + TAG_END);
			else
				buffer.append(TAG_ENV_VALUE + EQUAL + SINGLE_QUATATION
						+ oneCode.getPersistInfo().getObjectIdentifier().toString() + "," + oneCode.getCode()
						+ SINGLE_QUATATION + TAG_END);
...
//				"</OPTION>");
	...
	public static String getType() {
		...
		while (cadcreator.hasMoreElements()) {
			...
			buffer.append(TAG_COMMAND_OPTION + BLANK);
			buffer.append(
					TAG_ENV_VALUE + EQUAL + SINGLE_QUATATION + oneCode.getPersistInfo().getObjectIdentifier().toString()
							+ "," + oneCode.getCode() + SINGLE_QUATATION + TAG_END);
			buffer.append(oneCode.getName() + "[" + oneCode.getCode() + "]");
			buffer.append(TAG_START + SLASH + TAG_COMMAND_OPTION + TAG_END);
			buffer.append("\n");
		}
	...
	public static String getAjaxGagongCode(String key, String parentOid) {
		...
		QueryResult cadcreator = ObjectCodeHelper.getChildCode("CADATTRIBUTE",
				assy.getPersistInfo().getObjectIdentifier().toString());
		while (cadcreator.hasMoreElements()) {
			oneCode = (NumberCode) cadcreator.nextElement();
			buffer.append(oneCode.getName() + BLANK + "[" + oneCode.getCode() + "]");
			buffer.append(AJAX_ATTR);
