...
SELECT WTPartNumber FROM wcadmin.WTPartMaster WHERE WTPartNumber LIKE 'NP-05-0302-%' order by createStampA2 desc
SELECT (convert( bigint, SUBSTRING( ISNULL( MAX(WTPartNumber),'NP-05-0302-'),11, len( ISNULL( MAX(WTPartNumber),'00000') ) ) )*-1)+1 FROM wcadmin.WTPartMaster WHERE WTPartNumber LIKE 'NP-05-0302%' and len( WTPartNumber)=16  AND RIGHT(WTPartNumber, 4) <> '.PRT' ;
ddd
		*/
