...
//	}
	...
	public String getHtml(String formName){
		...
		else sb.append("  <td class='small' width=200><span class='small'>[��ü������:"+ksize+"][��ü����:"+total+"]</span></td>");
		sb.append("  <td>");
		...
		if(start>1){
			sb.append("<a href='JavaScript:gotoPageQuery"+formName+key+"(1)' class='small'><img src='/plm/jsp/portal/images/img_lotte/BBS_start.gif' border='0' align='middle'></a>");
		}
		sb.append("</td>");
		sb.append("				<td width='1' bgcolor='#dddddd'></td>");
		
		if(start>1){
		sb.append("				<td width='30' class='quick' align='center'><a href='JavaScript:gotoPageQuery"+formName+key+"("+(start-1)+")' class='smallblue'><img src='/plm/jsp/portal/images/img_lotte/BBS_prev.gif' border='0' align='middle'></a></td>");
		sb.append("				<td width='1' bgcolor='#dddddd'></td>");
		}
		...
		if(end < ksize){
		sb.append("				<td width='1' bgcolor='#dddddd'></td>");
		sb.append("				<td width='30' align='center'><a href='JavaScript:gotoPageQuery"+formName+key+"("+(end+1)+")' class='smallblue'><img src='/plm/jsp/portal/images/img_lotte/BBS_next.gif' border='0' align='middle'></a></td>");
		};
		sb.append("				<td width='1' bgcolor='#dddddd'></td>");
		sb.append("				<td width='30'align='center'>");
		
		if(end<ksize){
			sb.append("<a href='JavaScript:gotoPageQuery"+formName+key+"("+ksize+")' class='small'><img src='/plm/jsp/portal/images/img_lotte/BBS_end.gif' border='0' align='middle'></a>");
		}
		sb.append("				</td>");
		sb.append("			</tr>");
		sb.append("		</table>");
