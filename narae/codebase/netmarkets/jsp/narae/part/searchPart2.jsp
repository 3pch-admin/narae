        ...
        <td valign="top" width="100%">        
            ...
            <!--
                function doSubmit() {	
                    ...
                    form.method = "post";
                    form.action= "/Windchill/netmarkets/jsp/narae/part/searchPartList2.jsp";
                    form.target = "list";
                    form.submit();
                }
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
				                ...
				                <tr bgcolor="#ffffff">
				                    <td align="center" valign="top">
				                        <iframe src="/Windchill/netmarkets/jsp/narae/part/searchPartList2.jsp?fid=<%=foid%>&islastversion=true&moudleType=<%=moudleType%>&mode=<%=mode%>&number=<%=number %>"
