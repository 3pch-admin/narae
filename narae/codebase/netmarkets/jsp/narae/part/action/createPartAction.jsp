<%@page import="ext.narae.service.part.beans.PartHelper"%>
...
<%@ page import="ext.narae.component.*, wt.part.*" %>
...
// 파일 추출
	...
	String oid = "";
	try {
		WTPart part = PartHelper.createPart(hash);
		if( part != null ) {
