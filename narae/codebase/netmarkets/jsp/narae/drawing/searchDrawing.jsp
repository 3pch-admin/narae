...
String CHECKWAIT = WTMessage.getLocalizedMessage(RESOURCE , "CHECKWAIT", new Object[]{}, locale);
String APPROVEWAIT = WTMessage.getLocalizedMessage(RESOURCE , "APPROVEWAIT", new Object[]{}, locale);
String SENT_ERP = WTMessage.getLocalizedMessage(RESOURCE , "SENT_ERP", new Object[]{}, locale);
String RETURN = WTMessage.getLocalizedMessage(RESOURCE , "RETURN", new Object[]{}, locale);
...
<form name=drawingForm id=drawingForm >
		...
		<td valign="top" style="padding:0px 0px 0px 0px">
			...
			<col width='10%'><col width='40%'><col width='10%'><col width='40%'>				
				...
				<tr >
					...
					<td class="tdwhiteL">
						<input class="txt_field" type="text" value="" id="partFolder" name="partFolder" size=30 readOnly></input>
                    ...
                    <td class="tdwhiteL">
	                	<select name="state" id="state">
	                        ...
	                        <option value="CHECKWAIT"><%=CHECKWAIT%></option>
	                        <option value="APPROVEWAIT"><%=APPROVEWAIT%></option>
	                        <option value="SENT_ERP"><%=SENT_ERP%></option>
...
function doSubmit(){
	...
	if( detailFlag == "true" ) {
		if( partFolder == "" && state == "" && number == "" && name == "" && material == "" && treatment == "" && description == "" &&
				predate == "" && postdate == "" && authoringType == "" && creator == "") {
			alert("<%=M001%>");
			return;
		}
	} else {
		if( partFolder == "" && state == "" && number == "" && name == "" && material == "" && treatment == "" ) {
			alert("<%=M001%>");
			return;
		}
	}
