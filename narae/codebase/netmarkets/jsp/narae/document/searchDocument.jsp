...
<%@ page import="wt.folder.*, wt.util.*, wt.org.*, wt.session.*, wt.inf.container.*, ext.narae.util.*, ext.narae.ui.*, java.util.*" %>
<%
			...
			<col width='10%'><col width='40%'><col width='10%'><col width='40%'>
				...
				<tr>
					...
					<td class="tdwhiteL" colspan="3">
						...
						<input type=text  name='tempcreator' id='tempcreator' onkeyup="javascript:inputAjax();" 
							onFocus="javascript:initAjax(this.document.documentForm.creator,'/Windchill/netmarkets/jsp/narae/org/AjaxSearchUser.jsp',document.documentForm,150,7)"
						onkeydown="javascript:pressKeyAjax(this)" value="<%=tempcreator%>" readOnly>
...
<mvc:tableContainer compId="ext.narae.document.DocumentList" height="900"></mvc:tableContainer>
<script>
